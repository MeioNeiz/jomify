...
const playerStatsSchema = z
  .object({
    ...
    trade_kill_opportunities: z.number().nullable().optional(),
    trade_kill_attempts: z.number().nullable().optional(),
    trade_kills_succeed: z.number().nullable().optional(),
    trade_kill_attempts_percentage: z.number().nullable().optional(),
    trade_kills_success_percentage: z.number().nullable().optional(),
    trade_kill_opportunities_per_round: z.number().nullable().optional(),
    traded_death_opportunities: z.number().nullable().optional(),
    traded_death_attempts: z.number().nullable().optional(),
    traded_deaths_succeed: z.number().nullable().optional(),
    traded_death_attempts_percentage: z.number().nullable().optional(),
    traded_deaths_success_percentage: z.number().nullable().optional(),
    traded_deaths_opportunities_per_round: z.number().nullable().optional(),
  })
  .passthrough();
